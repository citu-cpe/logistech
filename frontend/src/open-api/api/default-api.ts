...
export const DefaultApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    getOrderedProductItemsByStatus: async (
      companyId: string,
      ...
      // verify required parameter 'companyId' is not null or undefined
      assertParamExists(
        'getOrderedProductItemsByStatus',
        'companyId',
        companyId
      );
      ...
      const localVarPath =
        `/api/v1/product/company/{companyId}/status/ordered`.replace(
          `{${'companyId'}}`,
          encodeURIComponent(String(companyId))
        );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    getProductItemsByCompany: async (
      companyId: string,
      options: any = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'companyId' is not null or undefined
      assertParamExists('getProductItemsByCompany', 'companyId', companyId);
      const localVarPath =
        `/api/v1/product/product-items/company/{companyId}`.replace(
          `{${'companyId'}}`,
          encodeURIComponent(String(companyId))
        );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const DefaultApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async getOrderedProductItemsByStatus(
      companyId: string,
      productItemByStatusDTO: ProductItemByStatusDTO,
      options?: any
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getOrderedProductItemsByStatus(
          companyId,
          productItemByStatusDTO,
          options
        );
     ...
     * @throws {RequiredError}
     */
    async getProductItemsByCompany(
      companyId: string,
      options?: any
    ): Promise<
      (
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getProductItemsByCompany(
          companyId,
          options
        );
      return createRequestFunction(
...
export class DefaultApi extends BaseAPI {
   ...
   * @memberof DefaultApi
   */
  public getProductItemsByCompany(companyId: string, options?: any) {
    return DefaultApiFp(this.configuration)
      .getProductItemsByCompany(companyId, options)
      .then((request) => request(this.axios, this.basePath));
  }
