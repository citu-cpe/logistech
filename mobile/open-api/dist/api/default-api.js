...
exports.DefaultApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        assignCourierToProductItem: (productItemId, assignCourierToProductItemDTO, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'productItemId' is not null or undefined
            common_1.assertParamExists("assignCourierToProductItem", "productItemId", productItemId);
            // verify required parameter 'assignCourierToProductItemDTO' is not null or undefined
            common_1.assertParamExists("assignCourierToProductItem", "assignCourierToProductItemDTO", assignCourierToProductItemDTO);
            const localVarPath = `/api/v1/product/product-item/{productItemId}/courier`.replace(`{${"productItemId"}}`, encodeURIComponent(String(productItemId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = common_1.serializeDataIfNeeded(assignCourierToProductItemDTO, localVarRequestOptions, configuration);
            return {
                url: common_1.toPathString(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        assignRfidToProductItem: (productItemId, assignRfidToProductItemDTO, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'productItemId' is not null or undefined
            common_1.assertParamExists("assignRfidToProductItem", "productItemId", productItemId);
            // verify required parameter 'assignRfidToProductItemDTO' is not null or undefined
            common_1.assertParamExists("assignRfidToProductItem", "assignRfidToProductItemDTO", assignRfidToProductItemDTO);
            const localVarPath = `/api/v1/product/product-item/{productItemId}/rfid`.replace(`{${"productItemId"}}`, encodeURIComponent(String(productItemId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = common_1.serializeDataIfNeeded(assignRfidToProductItemDTO, localVarRequestOptions, configuration);
            return {
                url: common_1.toPathString(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        getOrderedProductItemsByStatus: (companyId, productItemByStatusDTO, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'companyId' is not null or undefined
            common_1.assertParamExists("getOrderedProductItemsByStatus", "companyId", companyId);
            // verify required parameter 'productItemByStatusDTO' is not null or undefined
            common_1.assertParamExists("getOrderedProductItemsByStatus", "productItemByStatusDTO", productItemByStatusDTO);
            const localVarPath = `/api/v1/product/company/{companyId}/status/ordered`.replace(`{${"companyId"}}`, encodeURIComponent(String(companyId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        updateProductItemLocation: (productItemLocationDTO, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'productItemLocationDTO' is not null or undefined
            common_1.assertParamExists("updateProductItemLocation", "productItemLocationDTO", productItemLocationDTO);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = common_1.serializeDataIfNeeded(productItemLocationDTO, localVarRequestOptions, configuration);
            return {
                url: common_1.toPathString(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.DefaultApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        assignCourierToProductItem(productItemId, assignCourierToProductItemDTO, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.assignCourierToProductItem(productItemId, assignCourierToProductItemDTO, options);
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
        /**
         ...
         * @throws {RequiredError}
         */
        assignRfidToProductItem(productItemId, assignRfidToProductItemDTO, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.assignRfidToProductItem(productItemId, assignRfidToProductItemDTO, options);
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
        /**
         ...
         * @throws {RequiredError}
         */
        getOrderedProductItemsByStatus(companyId, productItemByStatusDTO, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.getOrderedProductItemsByStatus(companyId, productItemByStatusDTO, options);
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
        /**
        ...
        updateProductItemLocation(productItemLocationDTO, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.updateProductItemLocation(productItemLocationDTO, options);
                return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
        /**
